...
public class Consulta_de_DataBase {
    ...
    // Este bloque de código ingresa un registro nuevo en la tabla personas
    PersonaModels persona1 = new PersonaModels(1, 2, "Juan", "Lopez", "CI", "5729790", "Avda Von Grutter", "0994114188", "josespelt6@gmail.com", "Soltero");
    personas.RegistrarPersona(persona1);

    // Este bloque de código realiza la consulta a la base de datos y trae los datos de la tabla personas
    ...
    // Este bloque de código realiza una modificación en la tabla personas de la base de datos
    PersonaModels persona2 = new PersonaModels(1, 2, "Jose", "Spelt", "CI", "5729790", "Avda Von Grutter", "09941141128", "josespelt6@gmail.com", "Soltero");
    personas.ModificarPersona(persona2);

    // Este bloque de código realiza un delete en la base de datos de la tabla personas
    int id_persona = 1;
